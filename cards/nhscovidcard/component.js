...
class nhscovidcardCardComponent extends BaseCard['nhscovidcard'] {
  ...
  dataForRender(profile) {
    ...
    return {
      ...
      footnote: profile.c_contentLastUpdatedDate ? `Last updated ${profile.c_contentLastUpdatedDate} from <a href="https://www.nhs.uk/" target=”_blank”>The National Health Service</a>` : null,
